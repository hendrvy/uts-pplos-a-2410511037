...
// 2. Middleware Validasi JWT (Khusus rute yang perlu diproteksi)
...
// Auth Service tidak diproteksi JWT agar user bisa login
app.use('/api/auth', createProxyMiddleware({ target: 'http://localhost:3001', changeOrigin: true }));

// Service lain diproteksi oleh validasi JWT di level Gateway
